...
def draw_bbox_results(image,
                      results,
                      input_path,
                      font_path="/root/Smart_container/PaddleClas/deploy/utils/simfang.ttf",
                      save_dir=None):
    ...
    for result in results:
        ...
        draw.text((xmin + 4, start_y), text, fill=(255, 255, 255), font=font)

        draw.rectangle(
            [(xmin, ymin), (xmax, ymax)], outline=(255, 0, 0), width=6)
