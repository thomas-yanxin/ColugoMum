...
-  **文档全面升级**：提供[PP-ShiTu模型训练及部署文档](https://github.com/thomas-yanxin/Smart_container/blob/master/docs/readme_industry_v5.md)；
-  **部署方式优化**：预测速度提升**65**%，基于CPU整体流程控制在**1.2s**左右； 
