...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def set_ui(self):
        ...
        self.title_label.setGeometry(QRect(250*self.rate, 20*self.rate, 450*self.rate, 80*self.rate))
        self.title_label.setStyleSheet("color: #5453FF;"
                                       "background: transparent;"
                                       "font: 20pt \"黑体\";"
                                       "font-weight:bold;")
        self.title_label.setText("袋鼯麻麻——智能结算平台")

        self.setWindowTitle('袋鼯麻麻——智能结算平台')
        ...
        self.text.setText("袋鼯麻麻——智能结算平台使用指南")
